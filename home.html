        ...
        <img src="images/bms_logo.png" />
                ...
                <div class="right" id="about">
                    ...
                    <p class="lead" style="font-family: 'Roboto Condensed'; font-size:160%; ">
                        Rankings
                        <ul style="font-family: 'Roboto Condensed'; font-size:130%; "><li>
                        NIRF (2019)	69</li>
                        <li>Outlook India (2019)  40</li>
                       <li>India Today (2020)	24</li></ul>
                ...
                <div class="container-fluid pb-0 mb-0 justify-content-center text-light " style="background-color:black;height:550px;" id="contact">
                    <hr class="featurette-divider">

                    <h1 class="" style="">Contact</h1>
                    <div class="row test">
                        <div class="col-md-4 text-center" style="padding-left:2%;">
                            <img src="images/bmsce_logo.png" style="width:60%;">
                            <p style="padding-top:1%; font-size:120%;"><i class="fas fa-map-marker-alt"></i><span class="glyphicon glyphicon-map-marker"></span> Bangalore,India</p>
                            <div>
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d497699.9974198194!2d77.35072903896105!3d12.953847709359573!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBengaluru%2C%20Karnataka!5e0!3m2!1sen!2sin!4v1596180539411!5m2!1sen!2sin" width="150" height="60" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                            </div>
                            <p style="padding-top:1%; font-size:120%;"><i class="fas fa-phone-square"></i><span class="glyphicon glyphicon-phone"></span> Phone: +91 1111111111</p>
                            <p style="padding-top:1%; font-size:120%;"><i class="fas fa-envelope"></i><span class="glyphicon glyphicon-envelope"></span> Email: bmsce@bmsce.ac.in</p>
                        </div>
                        <div class="col-md-8" style="margin-right:2%; margin-left:-3%;">

                            <div class="row" style="margin-top:5%;">

                                <div class="col-sm-6 form-group">
                                    <input class="form-control" id="name" name="name" placeholder="Name" type="text" [A-Za-z ]{1,} required style="width:100%;height:120%;">
                                </div><br>
                                <div class="col-sm-6 form-group">
                                    <input class="form-control" id="email" name="email" placeholder="Email" type="email"  pattern="[a-z0-9.]+@+[a-z.]$" required style="width:100%;height:120%;">
                                </div>
                            </div>
                            <textarea class="form-control" id="comments" name="comments" placeholder="Comment" rows="5" style="width:100%;height:50%;margin-top:4%;"></textarea>
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    <button class="btn pull-right btn-outline-success" type="submit" style="margin-left:92%; margin-top:2%; width:8%; color:white;" onclick="reset()">Send</button>
                                    <script>
                                        function reset() {
